 ...
 */
final class Version20240218153436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meet (id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, text VARCHAR(250) NOT NULL, format VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, author_id BIGINT DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meet DROP CONSTRAINT meet__author_id__fk');
